...
<div class="modal fade" id="shelfmarks" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body" data-spy="scroll" data-target=".footerPagination" data-offset="0">
        <div class="row">
        <a name="A"></a>
        <h3 id="A">A</h3>
      ...
      <div class="footerPagination">
        <ul class="list-inline">
          ...
          <li class="letter"><a href="#F">F</a></li>
          ...
          <li class="letter"><a href="#X">X</a></li>
          <li class="letter"><a href="#Y">Y</a></li>
          <li class="letter"><a href="#Z">Z</a></li>
        </ul>
      </div>
      </div>
    </div>
    ...
    <div id="matchbox">
    	<div class="container">
    		<div class="row">
              ...
              <a href="user.php"><button type="submit" class="btn btn-default pull-right" style="margin-top: -20px;">Login</button></a>
