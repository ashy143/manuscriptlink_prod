        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ol class="breadcrumb pull-right">
                        <li><a href='./manuscripts.php'>view</a></li>
                        <li><a>edit</a></li>
        ...
        <script>
            $(document).ready(function(){
                ...
                function getTableRow(data){
                    ...
                    row += "<td data-id=" + data.mscript_id + "> <input type='button' class = 'form-control btn-success view_btn' value = 'View'></td>" ;
                    row += "<td data-id=" + data.mscript_id + "> <input type='button' class = 'form-control btn-success commit_btn' value = 'Commit'></td>" ;
                    row += "</tr>" ;
