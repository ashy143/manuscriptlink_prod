...
<?php
    ...
    if(isset($_GET['id'])){
      ...
      $manuscript = getFolioById($_GET['id']);
...
<form class="form-horizontal" >
        ...
        <legend>Folio Details </legend>
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-3">
                    <input id="mlinkno" name="mlinkno" type="text" placeholder="Mlink #" class="form-control" required="" value=<?php if($edit){echo "'" . $manuscript->mlinknum . "'"; }?> >
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-3"> 
                    <input id="century" name="century" type="text" placeholder="" class="form-control" required="" maxlength="45" value=<?php if($edit){echo "'" . $manuscript->century . "'"; } ?> >
                  </div>
                </div>
        ...
        <legend>Location Details </legend>
               ...
               <div class="form-group">
                  ...
                  <div class="col-xs-2" style="float:right;">
                    <input type="submit" value="<?php echo $submit_btn_val; ?>" class="form-control btn-danger" >
                  </div>
